...
- set endpoint in server with function in controller with simple Database-call (checked with Postman)
                                    ...
                                    <____________________create-react-app info____________________>
